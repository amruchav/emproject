...
<sf:form class="w3-card-4"  action="insertEmployeeDetails.ems" style="max-width:500px;margin: auto; padding:10px;" commandName="EmployeeDetails" modelAttribute="EmployeeDetails">
  <p>
